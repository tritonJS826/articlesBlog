...
* user-friendly logout/shutdown/reboot/switch betweeen accounts 

* не циклическое переключение языков
...
mode "exit: [l]ock, [e]logout, [r]eboot, [s]hutdown, s[u]spend, [d]m-tool switch" {
  ...
  bindsym d exec dm-tool switch-to-user veretennikovva
...
# custom config
# bacground image
# exec_always feh -Z --randomize --bg-fill ~/Archive/triton-triton\(files\ from\ childhood\)/picturesForGame/* ~/Archive/triton-triton\(files\ from\ childhood\)/* ~/Archive/photoVideo/**
# toggle touchpad
exec_always /home/veretennikovva/scripts/toggleTouchpad.sh
# network-manager applet
exec_always nm-applet
# startvolume control applet
exec pasystray
# bluetooth applet
exec_always blueman-applet
exec_always gsettings set org.blueman.plugins.powermanager auto-power-on false

#desktop black wallpaper
exec --no-startup-id xsetroot -solid "#000000"

# change keyboard layout on CapsLock
exec --no-startup-id setxkbmap -option caps:none
bindcode Shift+66 exec setxkbmap ru
bindcode 66 exec setxkbmap us
# deprecated cyclic keyboard layout
...
bindsym $alt+F3 exec --no-startup-id xfce4-appfinder

#interactive screenshot by pressing printscreen
bindsym Print exec xfce4-screenshooter 

# Moving workspaces between screens (xrandr --output HDMI-0 --auto --left-of eDP-1-0)
