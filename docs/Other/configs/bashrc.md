...
alias l='ls -CF'
# ------------------------- custom aliases
# custom aliases translatinig
alias tru='trans -p en:ru'
alias ten='trans -p ru:en'

# custom aliases fan control
...
# chatgpt aliases
alias gpt='export OPENAI_API_KEY="..........." && chatgpt'

#custom git aliases
alias gac='git add --all && git commit && git push'
alias gs='git status'
alias gre='git clean -df && git reset --hard HEAD~1'
...
# pnpm
export PNPM_HOME="/home/triton/.local/share/pnpm"
